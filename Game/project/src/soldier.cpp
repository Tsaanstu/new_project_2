//
// Created by tsaanstu on 14.10.18.
//
...
void Soldier::read_data_from_file(std::string path_file) {
    std::string src = PATH_TO_SOLDIER + path_file + ".txt";
    std::ifstream fin(src);
    if (!fin.is_open()) {
        std::cout << PATH_TO_SOLDIER << path_file << ".txt ";
        std::cout << "not found\n";
        return;
    }
